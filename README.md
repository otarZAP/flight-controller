...
- [Build manual](https://otarzap.github.io/flight-controller/guide.html) — **the full illustrated build manual** (schematics, board layout, pin map, bring-up sequence)
- [Solder to Sky](https://otarzap.github.io/flight-controller/tutorial.html) — step-by-step build-along tutorial
